...
def static "win10_Operations.VE.paste_and_enter"() {
    (new win10_Operations.VE()).paste_and_enter()
}

def static "win10_Operations.VE.up_button"() {
    (new win10_Operations.VE()).up_button()
}

def static "win10_Operations.VE.down_button"() {
    (new win10_Operations.VE()).down_button()
}

def static "win10_Operations.VE.alt_down"() {
    (new win10_Operations.VE()).alt_down()
}

def static "win10_Operations.VE.tab_button"() {
    (new win10_Operations.VE()).tab_button()
}

def static "win10_Operations.VE.refreshBrowser"() {
    (new win10_Operations.VE()).refreshBrowser()
}

def static "win10_Operations.VE.clickElement"(
    	TestObject to	) {
    (new win10_Operations.VE()).clickElement(
        	to)
}

def static "win10_Operations.VE.getHtmlTableRows"(
    	TestObject table	
     , 	String outerTagName	) {
    (new win10_Operations.VE()).getHtmlTableRows(
        	table
         , 	outerTagName)
}
